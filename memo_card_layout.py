...
btn_Sleep = QPushButton('Відпочити') # кнопка, що прибирає вікно і повертає його після закінчення таймера
...
# ----------------------------------------------------------
# Створюємо панель із варіантами відповідей:
# ----------------------------------------------------------
...
RadioGroupBox.setLayout(layout_ans1) # готова "панель" із варіантами відповідей
